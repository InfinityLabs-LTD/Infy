    ...
    <div className="p-4 md:p-6 max-w-3xl">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-xs" style={{ color: 'var(--text-low)' }}>Управление ассистентом Infy Pulse</p>
        </div>
        {saved && (
      ...
      <div className="glass rounded-2xl p-4 mb-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs mt-0.5" style={{ color: 'var(--text-low)' }}>
            Доступ к Infy Pulse в чатах: поиск по переписке, веб-поиск, планы, подсказки, /ask
          </p>
        </div>
