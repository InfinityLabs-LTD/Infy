  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 bg-white border-b border-gray-100 px-4 py-2.5 flex items-center gap-3 shadow-sm z-10">
        <Link to="/" className="md:hidden shrink-0 w-8 h-8 flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors -ml-1">
