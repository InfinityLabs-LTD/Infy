...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/badges', label: 'Бейджи', icon: icon(<><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></>) },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/admin/backups', label: 'Бэкапы', icon: icon(<><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></>) },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/mail', label: 'Почта', icon: icon(<><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 5L2 7"/></>) },
